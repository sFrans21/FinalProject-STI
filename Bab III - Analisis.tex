...
\subsection{Prosedur Diagnosis Hipertensi Secara Luring}
...
\begin{figure}[H]
    ...
    \caption{Alur diagnosis hipertensi di fasilitas kesehatan tingkat pertama}
    \label{fig:alur-konvensional}
\end{figure}

\subsection{Prosedur Diagnosis Hipertensi Secara Daring}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{1.5cm}|p{4.5cm}|p{7.5cm}|}
        ...
        \hline
        NFR01 & Pengujian Hasil Prediksi & Model prediksi harus memprioritaskan kemampuan untuk meminimalkan \emph{False Negative}, untuk mencegah pasien hipertensi tidak terdeteksi \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.5cm}|p{3.5cm}|p{4.5cm}|p{4.5cm}|}
        ...
        \hline
        3. & Narasi LLM dengan \textit{direct prompting} & Penjelasan yang lebih mudah dipahami orang awam. & Rentan terhadap halusinasi. \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3cm}|p{1cm}|p{2cm}|p{2.2cm}|p{2.2cm}|p{3cm}|}
        \hline
        \textbf{Parameter} & \textbf{Bobot} & \textbf{Rule-Based System} & \textbf{ML} & \textbf{LLM Chatbot} & \textbf{Hybrid System (ML+XAI+RAG)} \\
        \hline
