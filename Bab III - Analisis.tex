...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3cm}|p{1cm}|p{2cm}|p{2.2cm}|p{2.2cm}|p{2.5cm}|}
        \hline
        \textbf{Parameter} & \textbf{Bobot} & \textbf{Rule-Based System} & \textbf{Pure ML (\textit{black box})} & \textbf{LLM Chatbot (Direct)} & \textbf{Hybrid System (ML+XAI+RAG)} \\
        \hline
