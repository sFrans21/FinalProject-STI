...
% --- Kolom tabularx rata kiri yang melar (dipakai di Bab VI) ---
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
% --- Kolom lebar-tetap rata tengah, mis. C{3.2cm} (dipakai di Bab VI) ---
...
% \input{11 Daftar Listing.tex} % dinonaktifkan: tidak ada listing kode dalam dokumen (kode sumber via tautan GitHub pada Lampiran A)
