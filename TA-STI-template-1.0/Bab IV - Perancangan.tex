...
Berdasarkan analisis masalah dan pemilihan solusi pada bab sebelumnya, penelitian ini mengusulkan arsitektur sistem yang mengintegrasikan \textit{Machine Learning} (ML), \textit{Explainable Artificial Intelligence} (XAI), dan \textit{Large Language Model} (LLM) berbasis \textit{Retrieval-Augmented Generation} (RAG).
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\textwidth]{image/Desain Konsep Solusi.png} 
...
\begin{figure}[H]
    \centering
    % Pastikan nama file tidak menggunakan spasi. Gunakan underscore atau dash.
    \includegraphics[width=0.8\textwidth]{image/alur kerja sistem.png} 
