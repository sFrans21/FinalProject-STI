...
\begin{center}
    ...
    {\Large\bfseries\uppercase{Pengembangan Sistem Informasi Berbasis Machine Learning dan Explainiable Artificial Intelligence untuk Prediksi Risiko Hipertensi} 
}\\
     \vspace{4cm}
