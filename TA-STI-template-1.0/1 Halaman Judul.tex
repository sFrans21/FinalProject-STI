...
\begin{center}
    ...
    {\Large\bfseries\uppercase{Pengembangan Sistem Informasi Berbasis Explainiable Artificial Intelligence dan Large Language Model untuk Prediksi Risiko Hipertensi} 
}\\
     \vspace{4cm}
