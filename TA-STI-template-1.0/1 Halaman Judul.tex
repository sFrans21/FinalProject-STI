...
\begin{center}
    ...
    {\Large\bfseries\uppercase{Pengembangan Sistem Informasi Berbasis Machine Learning dan Explainable Artificial Intelligence untuk Estimasi Risiko Hipertensi} 
}\\
     \vspace{4cm}
