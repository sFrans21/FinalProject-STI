...
\begin{center}
    ...
    \textbf{Pengembangan Sistem Informasi Berbasis Machine Learning dan Explainable Artificial Intelligence dan Large Language Model untuk Prediksi Risiko Hipertensi} \\
    \vspace{0.4cm}
    oleh \\
    \vspace{0.4cm}
    John Doe\\
