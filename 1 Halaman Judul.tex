...
\begin{center}
    ...
    {\Large\bfseries\uppercase{Pengembangan Sistem Informasi Berbasis Machine Learning dan Explainable Arfiticial Intelligence untuk Prediksi Risiko Hipertensi} 
}\\
     \vspace{4cm}
